...
class WaitlistPromotedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('A spot opened up — it\'s yours')
            ->line(str_replace([':class', ':when'], [$className, $when], 'You were promoted from the waitlist: :class on :when is now confirmed for you.'))
